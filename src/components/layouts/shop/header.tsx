...
export default function Header() {
  ...
  return (
    <>
      <header>
        <div
          className={`fixed bg-white top-0 z-50 w-full transition-all duration-500 ease-in-out ${
            isSticky ? 'shadow-lg transform-gpu -translate-y-15' : ''
          }`}
        >
          {/* Header 1 */}
            ...
            <div className="grow flex items-center justify-center">
              <ul className="flex gap-8 text-gray-500 text-[17px] ">
                ...
                <li className="relative group hover:text-[#81c408] ">
                  ...
                  <ul className="absolute z-100 mt-2 left-0 bg-gray-100 text-black w-45 rounded-md shadow-lg  transform-gpu scale-y-0 -translate-y-2 opacity-0 origin-top group-hover:translate-y-0 group-hover:opacity-100 group-hover:scale-y-100  transition-all duration-400 ">
